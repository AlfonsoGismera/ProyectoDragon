package es.Alfonso.tienda.storage;
...
public class FileSystemStorageService implements StorageService {
     ...
     * del fichero a almacenar. Como lo asociamos al Usuario que se ha
     * dado de alta, usaremos el ID de usuario como nombre de fichero.
     */
    @Override
